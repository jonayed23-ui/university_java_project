...
public class Category2 extends JFrame implements ActionListener {
    ...
    public Category2(String user){
        ...
        ImageIcon framelogo     = new ImageIcon("icons/logo.png");
        ...
        rlaptop.setFont(new Font("Areal",Font.PLAIN,15));
        c.add(rlaptop);
        ...
        prlaptop.setFont(new Font("Areal",Font.PLAIN,15));
        c.add(prlaptop);
        ...
        nmlaptop.setFont(new Font("Areal",Font.PLAIN,15));
        c.add(nmlaptop);
        ...
        rmobile.setFont(new Font("Areal",Font.PLAIN,15));
        c.add(rmobile);
        ...
        prmobile.setFont(new Font("Areal",Font.PLAIN,15));
        c.add(prmobile);
        ...
        nmmobile.setFont(new Font("Areal",Font.PLAIN,15));
        c.add(nmmobile);
        ...
        rmonitor.setFont(new Font("Areal",Font.PLAIN,15));
        c.add(rmonitor);
        ...
        prmonitor.setFont(new Font("Areal",Font.PLAIN,15));
        c.add(prmonitor);
        ...
        nmmonitor.setFont(new Font("Areal",Font.PLAIN,15));
        c.add(nmmonitor);
